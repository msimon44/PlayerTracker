...
export default function ActiveFormsScreen() {
    ...
    const myQuestions = [
        { question: 'How are you feeling today?', type: 'NoteQuestion' },
        { question: 'Did you sleep well?', type: 'YesNoQuestion' },
        { question: 'Rate your pain level', type: 'ScaleQuestion' },
    ];

    const pushForm = () => {
        console.log('Access to form');
        router.push({
            pathname: '/(tabs)/form',
            params: {
                // serialize objects to strings
                questions: JSON.stringify(myQuestions),
            },
        });
    };
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.titleContainer}>Active Forms</Text>
            <CardList data={mockData} onCardPress={pushForm} />
        </View>
    );
}
